...
Donate link: https://berocket.com/product/woocommerce-grid-list-view?utm_source=wordpress_org&utm_medium=donate&utm_campaign=list_grid
...
= Plugin Links: =
[Paid Plugin](https://berocket.com/product/woocommerce-grid-list-view?utm_source=wordpress_org&utm_medium=plugin_links&utm_campaign=list_grid)
[Demo 1](https://woocommerce-grid-list.berocket.com/shop/?utm_source=wordpress_org&utm_medium=plugin_links&utm_campaign=list_grid)
[Demo 2](https://woocommerce-terms-popup.berocket.com/?utm_source=wordpress_org&utm_medium=plugin_links&utm_campaign=list_grid)
[Demo Description](https://woocommerce-grid-list.berocket.com/?utm_source=wordpress_org&utm_medium=plugin_links&utm_campaign=list_grid)


= &#127852; Wanna try admin side? =
[Admin Demo](https://berocket.com/product/woocommerce-grid-list-view?utm_source=wordpress_org&utm_medium=admin_demo&utm_campaign=list_grid#try-admin) - Get access to this plugin's admin and try it from inside. Change things and watch how they work.

= Premium plugin video =
[youtube https://youtu.be/LGV7Im4Bfds]
...
== Installation ==
Important: First of all, you have to download and activate WooCommerce plugin, because without it Grid/List View for WooCommerce cannot work.

1. Unzip the downloaded .zip file.
2. Upload the Grid/List View for WooCommerce folder into the `wp-content/plugins/` directory of your WordPress site.
3. Activate `Grid/List View for WooCommerce` from Plugins page

= Configuration =
Grid/List View for WooCommerce will add a new sub-menu item called "Grid/List View" in "WooCommerce" menu. There you will be able to access plugin settings page.
...
You can get more features with the premium version of Grid/List View for WooCommerce, available on [BeRocket page](https://berocket.com/product/woocommerce-grid-list-view?utm_source=wordpress_org&utm_medium=faq&utm_campaign=list_grid). Here you can read more about the premium features of the plugin and make it give it its best shot!


= How can I try the full-featured plugin? =
You can try this plugin's admin side [here](https://berocket.com/product/woocommerce-grid-list-view?utm_source=wordpress_org&utm_medium=faq&utm_campaign=list_grid#try-admin). Configure plugin the way you need to check the results.

---

== Screenshots ==
1. Buttons settings
2. Product count settings
...
= 1.1.0.2 =
* Fix - Error with static function

= 1.1.0.1 =
* Fix - Links to BeRocket
* Fix - Compatibility with other BeRocket plugins
* Fix - Button styles
* Fix - File for Loco Translate

= 1.1 =
* Enhancement - new admin settings design
* Fix - Some styles was incorrect

= 1.0.12 =
* Fix - Compatibility with WooCommerce  3.6

= 1.0.11 =
* Enhancement - Fixed products style on selected pages
* Fix - Subscribe
...
* Fix/Enhancement - Other bugs

= 1.0.2 =
* Enhancement - Settings save
* Fix/Enhancement - Colorpick block doesn't displayed
* Fix/Enhancement - Plugin name and description
* Fix/Enhancement - Other bugs
